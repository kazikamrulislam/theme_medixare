    ...
    <div class="tab">
      <div class="tab-menu">
        <button class="tab-menu-link active" data-content="first">
          <span data-title="first"><?php esc_html_e('WPBakery Page Builder', 'amt-demo-importer'); ?></span>
        </button>
        <button class="tab-menu-link" data-content="second">
          <span data-title="second"><?php esc_html_e('Elementor Page Builder', 'amt-demo-importer'); ?></span>
        </button>
      </div>
      <div class="tab-bar">
