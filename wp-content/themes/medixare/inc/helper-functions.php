...
if ( !class_exists( 'MedixareTheme_Helper' ) ) {
	
	class MedixareTheme_Helper {
		...
		public static function pagination() {
			...
			include MEDIXARE_VIEW_DIR . 'pagination.php';
		}	

		public static function comments_callback( $comment, $args, $depth ){
			include MEDIXARE_VIEW_DIR . 'comments-callback.php';
		}
		...
		public static function fonts_url(){
			...
			// Body Font
			$body_font  = json_decode( MedixareTheme::$options['typo_body'], true );
			...
			// Menu Font
			$menu_font  = json_decode( MedixareTheme::$options['typo_menu'], true );
			...
			$h_font  = json_decode( MedixareTheme::$options['typo_heading'], true );
			...
			$h1_font  = json_decode( MedixareTheme::$options['typo_h1'], true );
			$h2_font  = json_decode( MedixareTheme::$options['typo_h2'], true );
			$h3_font  = json_decode( MedixareTheme::$options['typo_h3'], true );
			$h4_font  = json_decode( MedixareTheme::$options['typo_h4'], true );
			$h5_font  = json_decode( MedixareTheme::$options['typo_h5'], true );
			$h6_font  = json_decode( MedixareTheme::$options['typo_h6'], true );

			if ( 'off' !== _x( 'on', 'Google font: on or off', 'medixare' ) ) {
				...
				// Body Font
				if ( 'off' !== $bodyFont )
					$font_families[] = $bodyFont.':400,500,600,700,'.$bodyFW;
		...
		public static function socials(){
			$medixare_socials = array(
				'social_facebook' => array(
					'icon' => 'fa-facebook-f',
					'url'  => MedixareTheme::$options['social_facebook'],
				),
				'social_twitter' => array(
					'icon' => 'fa-twitter',
					'url'  => MedixareTheme::$options['social_twitter'],
				),
				'social_behance' => array(
					'icon' => 'fa-behance',
					'url'  => MedixareTheme::$options['social_behance'],
				),
				'social_dribbble' => array(
					'icon' => 'fa-dribbble',
					'url'  => MedixareTheme::$options['social_dribbble'],
				),
				'social_linkedin' => array(
					'icon' => 'fa-linkedin-in',
					'url'  => MedixareTheme::$options['social_linkedin'],
				),
				'social_youtube' => array(
					'icon' => 'fa-youtube',
					'url'  => MedixareTheme::$options['social_youtube'],
				),
				'social_pinterest' => array(
					'icon' => 'fa-pinterest-p',
					'url'  => MedixareTheme::$options['social_pinterest'],
				),
				'social_instagram' => array(
					'icon' => 'fa-instagram',
					'url'  => MedixareTheme::$options['social_instagram'],
				),
				'social_skype' => array(
					'icon' => 'fa-skype',
					'url'  => MedixareTheme::$options['social_skype'],
				),
				'social_rss' => array(
					'icon' => 'fas fa-rss',
					'url'  => MedixareTheme::$options['social_rss'],
				),
				'social_snapchat' => array(
					'icon' => 'fa-snapchat-ghost',
					'url'  => MedixareTheme::$options['social_snapchat'],
				),
			);
			return array_filter( $medixare_socials, array( 'MedixareTheme_Helper' , 'filter_social' ) );
		}
		public static function team_socials(){
			$team_socials = array(
				'facebook' => array(
					'label' => esc_html__( 'Facebook', 'medixare' ),
					'type'  => 'text',
					'icon'  => 'fa-facebook-f',
				),
				'twitter' => array(
					'label' => esc_html__( 'Twitter', 'medixare' ),
					'type'  => 'text',
					'icon'  => 'fa-twitter',
				),
				'linkedin' => array(
					'label' => esc_html__( 'Linkedin', 'medixare' ),
					'type'  => 'text',
					'icon'  => 'fa-linkedin-in',
				),
				'behance' => array(
					'label' => esc_html__( 'Behance', 'medixare' ),
					'type'  => 'text',
					'icon'  => 'fa-behance',
				),
				'dribbble' => array(
					'label' => esc_html__( 'Dribbble', 'medixare' ),
					'type'  => 'text',
					'icon'  => 'fa-dribbble',
				),
				'skype' => array(
					'label' => esc_html__( 'Skype', 'medixare' ),
					'type'  => 'text',
					'icon'  => 'fa-skype',
				),
				'youtube' => array(
					'label' => esc_html__( 'Youtube', 'medixare' ),
					'type'  => 'text',
					'icon'  => 'fa-youtube',
				),
				'pinterest' => array(
					'label' => esc_html__( 'Pinterest', 'medixare' ),
					'type'  => 'text',
					'icon'  => 'fa-pinterest-p',
				),
				'instagram' => array(
					'label' => esc_html__( 'Instagram', 'medixare' ),
					'type'  => 'text',
					'icon'  => 'fa-instagram',
				),
				'github' => array(
					'label' => esc_html__( 'Github', 'medixare' ),
					'type'  => 'text',
					'icon'  => 'fa-github',
				),
				'stackoverflow' => array(
					'label' => esc_html__( 'Stackoverflow', 'medixare' ),
					'type'  => 'text',
					'icon'  => 'fa-stack-overflow',
				),
			);
			return apply_filters( 'MedixareTheme_Helper', $team_socials );
		}

		public static function nav_menu_args(){
			$medixare_pagemenu = false;
			if ( ( is_single() || is_page() ) ) {
				$layout_settings2 = get_post_meta( get_the_id(), 'medixare_layout_settings', true );
				if ( !empty( $layout_settings2 ) ) {
					$medixare_menuid = $layout_settings2['medixare_page_menu'];
				} else {
					$medixare_menuid = '';
				}
				if ( !empty( $medixare_menuid ) && $medixare_menuid != 'default' ) {
					$medixare_pagemenu = $medixare_menuid;
				}
			}
			if ( $medixare_pagemenu ) {
				$nav_menu_args = array( 'menu' => $medixare_pagemenu,'container' => 'nav' );
			}
			else {
		...
		public static function has_footer(){
			...
			if ( MedixareTheme::$footer_style == 2  ) {
				$footer_column = MedixareTheme::$options['footer_column_2'];
				...
				return false;
			} else if ( MedixareTheme::$footer_style == 3 ) {
				$footer_column = MedixareTheme::$options['footer_column_3'];
				for ( $i = 1; $i <= $footer_column; $i++ ) {
					if ( is_active_sidebar( 'footer-'. $i ) ) {
						return true;
					}
				...
				return false;				
			} else if ( MedixareTheme::$footer_style == 4 ) {
				$footer_column = MedixareTheme::$options['footer_column_4'];
				for ( $i = 1; $i <= $footer_column; $i++ ) {
					if ( is_active_sidebar( 'footer-'. $i ) ) {
						return true;
					}
				...
				return false;
			} else if ( MedixareTheme::$footer_style == 5 ) {
				$footer_column = MedixareTheme::$options['footer_column_5'];
				for ( $i = 1; $i <= $footer_column; $i++ ) {
					if ( is_active_sidebar( 'footer-'. $i ) ) {
						return true;
					}
		...
		public static function get_font_css( $filename ){
			$path = '/assets/fonts/flaticon-medixare/' . $filename . '.css';
		...
		public static function has_active_widget(){
			...
			if ( ( class_exists( 'WooCommerce' ) && is_shop() ) || ( class_exists( 'WooCommerce' ) && is_product_category() ) || ( class_exists( 'WooCommerce' ) && is_product_tag() ) || ( class_exists( 'WooCommerce' ) && is_product() ) ) {	
				...
				if ( is_active_sidebar( 'shop-sidebar-1' ) ) {
					$medixare_layout_class = "col-xl-8 col-lg-8 {$sidebar_order}";
				} else {
			...
			if ( MedixareTheme::$sidebar ) {
				if ( is_active_sidebar( MedixareTheme::$sidebar ) ) {
					$medixare_layout_class = "col-xl-8 col-lg-8 {$sidebar_order}";
				} else {
					$medixare_layout_class = 'col-12';
				}
		...
		public static function custom_sidebar_fields(){
			...
			$sidebar_fields['sidebar'] = esc_html__( 'Sidebar', 'medixare' );

			$sidebars = get_option( 'medixare_custom_sidebars', array() );
			if ( $sidebars ) {
		...
		public static function dynamic_internal_style(){
			ob_start();
			include MEDIXARE_INC_DIR . 'variable-style.php';
			include MEDIXARE_INC_DIR . 'variable-style-elementor.php';
			$dynamic_css  = ob_get_clean();
			$dynamic_css  = self::minified_css( $dynamic_css );
			wp_register_style( 'medixare-dynamic', false );
			wp_enqueue_style( 'medixare-dynamic' );
			wp_add_inline_style( 'medixare-dynamic', $dynamic_css );
		}
	}
}