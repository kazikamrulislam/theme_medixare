 ...
 */
 ...
 /*CREDIT : Jannah theme( TieLab ), Modified By AddonMonster*/
 
if ( ! defined( 'ABSPATH' ) ) exit; // Exit if accessed directly

if( ! function_exists( 'medixare_breadcrumbs' )){

	function medixare_breadcrumbs(){
		...
		$home_text  = esc_html__( 'Home', 'medixare' );
		...
		if ( ! is_home() && ! is_front_page() || is_paged() ){
			...
			elseif ( is_singular() ){			
				...
				if ( get_post_type() == 'post' ){
					...
					$category = medixare_get_primary_category_id();
					$category = get_category( $category );
