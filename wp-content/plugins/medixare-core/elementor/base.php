...
abstract class Custom_Widget_Base extends Widget_Base {
	...
	public $amt_category;
	public $amt_icon;
	public $amt_translate;

	public function __construct( $data = [], $args = null ) {
		$this->amt_category = MEDIXARE_CORE_THEME_PREFIX . '-widgets'; // Category /@dev
		$this->amt_icon     = 'amtheme-el-custom';
		parent::__construct( $data, $args );
	}

	abstract public function amt_fields();

	public function get_name() {
		return $this->amt_base;
	}
	...
	public function get_icon() {
		return $this->amt_icon;
	}

	public function get_categories() {
		return array( $this->amt_category );
	}

	protected function register_controls() {
		$fields = $this->amt_fields();
	...
	public function amt_template( $template, $data ) {
    ...
    public function get_taxonomy_drops($taxonomy='category'){
