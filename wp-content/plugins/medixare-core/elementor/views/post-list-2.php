...
<div class="amt-post-list-default amt-post-list-<?php echo esc_attr( $data['style'] );?>">
	<?php $count = 1; $i = $data['delay']; $j = $data['duration']; 
		...
		<?php while ( $query->have_posts() ) : $query->the_post();?>
				...
				<div class="<?php echo esc_attr( $data['animation'] );?> <?php echo esc_attr( $data['animation_effect'] );?>" data-wow-delay="<?php echo esc_attr( $i );?>s" data-wow-duration="<?php echo esc_attr( $j );?>s">
					<div class="amt-item single-post-item">
						...
						<div class="entry-content">							
							...
							<?php } ?>
							<h3 class="entry-title title-size-md title-dark-color"><a href="<?php the_permalink();?>"><?php echo esc_html( $title );?></a></h3>
			...
			<?php if ( $count > 1 ) { ?>
				<div class="<?php echo esc_attr( $data['border_on_off'] );?> <?php echo esc_attr( $data['animation'] );?> <?php echo esc_attr( $data['animation_effect'] );?>" data-wow-delay="<?php echo esc_attr( $i );?>s" data-wow-duration="<?php echo esc_attr( $j );?>s">			
