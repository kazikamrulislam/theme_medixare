	...
	public function amt_fields(){
		...
		$fields = array(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .amt-post-grid-default .tp-service__item' => 'margin-bottom: {{SIZE}}{{UNIT}};',
				),
			),
			array(
				'type'    => Controls_Manager::NUMBER,
			...
			array(
	            ...
	            'selectors' => array(
	                '{{WRAPPER}} .amt-post-grid-default .tp-service__item .tp-service__thumb' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}} !important;',
	            ),
	            'separator' => 'before',
	        ),	        
			array(
	        ...
	        array (
				...
				'label'   => esc_html__( 'Style', 'medixare-core' ),
				'selector' => '{{WRAPPER}} .amt-post-grid-default .tp-service__item .tp-service__title',
			),
			// array(
			...
			// 	'selectors' => array(
			// 		'{{WRAPPER}} .amt-post-grid-default .tp-service__item .tp-service__title' => 'color: {{VALUE}}',
			// 	),
			// ),
			array(
				'type' => Controls_Manager::HEADING,
	        ...
	        array (
				...
				'name'    => 'sub_title_typo',
				'label'   => esc_html__( 'Style', 'medixare-core' ),
				'selector' => '{{WRAPPER}} .amt-post-grid-default .tp-service__item .tp-service__content .tp-service-desc',
			),
			array(
				'type'    => Controls_Manager::COLOR,
				...
				'label'   => esc_html__( 'Color', 'medixare-core' ),
				'selectors' => array(
					'{{WRAPPER}} .amt-post-grid-default .tp-service__item .tp-service__content .tp-service-desc' => 'color: {{VALUE}}',
				),
			),
			// array(
			...
			// 	'selector' => '{{WRAPPER}} .amt-post-grid-default .tp-service__item .tp-service__title a',
			// ),
			array(
	            'type'    => Controls_Manager::DIMENSIONS,
	            'mode'          => 'responsive',
	            ...
	            'selectors' => array(
	                '{{WRAPPER}} .amt-post-grid-default .tp-service__item .tp-service__content .tp-service-desc' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}} !important;',
	            ),
	            'separator' => 'before',
	        ),
			array(
			...
			// 	'default' => '',
			// 	'selectors' => array(
			// 		'{{WRAPPER}} .amt-post-grid-default .tp-service__item .post-author' => 'color: {{VALUE}}',
			// 	),
			// ),
			array(
				'type'    => Controls_Manager::COLOR,
				...
				'default' => '',
				'selectors' => array(
					'{{WRAPPER}} .amt-post-grid-default ul.entry-meta li i' => 'color: {{VALUE}}',
				),
			),
			array(
	            'type'    => Controls_Manager::DIMENSIONS,
	            ...
	            'selectors' => array(
	                '{{WRAPPER}} .amt-post-grid-default ul.entry-meta' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}} !important;',
	            ),
	            'separator' => 'before',
	        ),
	        array(
			...
			array(
	            ...
	            'label'   => __( 'Margin', 'medixare-core' ),                 
	            'selectors' => array(
	                '{{WRAPPER}} .amt-post-grid-default .tp-service__item .entry-categories' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}} !important;',
	            ),
	            'separator' => 'before',
	        ),
	        array(
			...
			array(
				...
				array(
					...
					array(
						...
						'selectors' =>[
							'{{WRAPPER}} .tp-readmore-btn'  => 'color: {{VALUE}};',
						],
						'default' => '#fff',
					),
					array(
						...
						'label'   => esc_html__( 'Background Color', 'medixare-core' ),
						'selectors' => [
							'{{WRAPPER}} .tp-readmore-btn' => 'background-color: {{VALUE}};',
						],
						'default' => '#ff4460',
					),
					array(
					...
					// 	'label'   => esc_html__( 'Text', 'medixare-core' ),
					// 	'selector' => '{{WRAPPER}} .tp-readmore-btn:hover',
					// 	'scheme'   => Scheme_Typography::TYPOGRAPHY_3,
					// ),
					array(
						'type'    => Controls_Manager::COLOR,
						...
						'label'   => esc_html__( 'Text Color', 'medixare-core' ),
						'selectors' =>[
							'{{WRAPPER}} .tp-readmore-btn:hover'  => 'color: {{VALUE}};',
						],
						'default' => '#fff',
					),
					array(
						...
						'label'   => esc_html__( 'Background Color', 'medixare-core' ),
						'selectors' => [
							'{{WRAPPER}} .tp-readmore-btn:hover' => 'background-color: {{VALUE}};',
						],
						'default' => '#ff9b40',
					),
					// array(
					...
					// 	],
					// 	'selectors' => [
					// 		'{{WRAPPER}} .tp-readmore-btn:hover' => 'border-style: {{VALUE}};',
					// 	],
					// 	'default' => 'none',
					// ),
					array(
					...
					// 	'label' => esc_html__( 'Border Radius', 'medixare-core' ),
					// 	'selectors' => [
					// 		'{{WRAPPER}} .tp-readmore-btn:hover' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					// 	],						
					// ),
					// array(
					// 	'type' => Controls_Manager::DIMENSIONS,
					...
					// 	'label' => esc_html__( 'Padding', 'medixare-core' ),
					// 	'selectors' => [
					// 		'{{WRAPPER}} .tp-readmore-btn:hover' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					// 	],
					// ),
					// array (
					// 	'mode'    => 'group',
