 ...
 */
class MedixareTheme_Team_Single_Layout_Settings extends MedixareTheme_Customizer {
    ...
    public function register_team_single_layout_controls( $wp_customize ) {
        ...
        $wp_customize->add_control( 'team_bgtype',
            array(
                ...
                'type' => 'select',
                'choices' => array(
                    'team_bgimg' => esc_html__( 'BG Image', 'medixare' ),
                    'team_bgcolor' => esc_html__( 'BG Color', 'medixare' ),
                ),
            )
        );
        ...
        $wp_customize->add_control( new WP_Customize_Media_Control( $wp_customize, 'team_bgimg',
            array(
                ...
                'active_callback' => 'amttheme_team_single_banner_bgimg_type_condition',
            )
        ) );
        ...
        $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'team_bgcolor',
            array(
                ...
                'priority' => 10, 
                'section' => 'team_single_layout_section', 
                'active_callback' => 'amttheme_team_single_banner_bgcolor_type_condition',
            )
        ));
...
if ( class_exists( 'WP_Customize_Control' ) ) {
	new MedixareTheme_Team_Single_Layout_Settings();
}
