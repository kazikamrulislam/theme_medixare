...
<div class="amt-post-overlay-default amt-post-overlay-<?php echo esc_attr( $data['style'] );?>">
	<div class="row <?php echo esc_attr( $data['left_right_order'] );?> <?php echo esc_attr( $data['item_space'] );?>">
					...
					<div class="amt-item-wrap <?php echo esc_attr( $data['animation'] );?> <?php echo esc_attr( $data['animation_effect'] );?>" data-wow-delay="<?php echo esc_attr( $i );?>s" data-wow-duration="<?php echo esc_attr( $j );?>s">
						<div class="amt-item amt-item-single">
							...
							<div class="entry-content">
								...
								<?php } ?>
								<h3 class="entry-title title-size-lg title-light-color"><a href="<?php the_permalink();?>"><?php echo esc_html( $title );?></a></h3>
			...
			<?php } ?>
				...
				<?php if ( $count > 1 ) { ?>
					<div class="col-12 <?php echo esc_attr( $data['animation'] );?> <?php echo esc_attr( $data['animation_effect'] );?>" data-wow-delay="<?php echo esc_attr( $i );?>s" data-wow-duration="<?php echo esc_attr( $j );?>s">
						<div class="amt-item amt-item-list flex-row-reverse">
							<div class="amt-image">
							...
							<div class="list-content entry-content">
								...
								<?php } ?>
								<h3 class="entry-title title-size-sm title-dark-color"><a href="<?php the_permalink();?>"><?php echo esc_html( $small_title );?></a></h3>								
							</div>
						</div>	
					</div>
				<?php } ?>
