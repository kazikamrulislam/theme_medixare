...
if (  MedixareTheme::$layout == 'right-sidebar' || MedixareTheme::$layout == 'left-sidebar' ){
	$post_classes = array( 'col-md-12 col-12 amt-grid-item blog-layout-1 ' . $wow . ' ' . $effect );
	$ul_class = 'side_bar';
} else {
	$post_classes = array( 'col-xl-12 col-md-12 col-12 amt-grid-item blog-layout-1 ' . $wow . ' ' . $effect );
	$ul_class = '';
}
