<?php
/*
#. Supported Fields : text, number, textarea, textarea_html, select, icon_select, checkbox, multi_select, multi_checkbox, radio, image, file, color_picker, date_picker, time_picker, time_picker_24
...
if( !class_exists( 'AMT_Postmeta_Fields' ) ){

	class AMT_Postmeta_Fields {
		...
		public function gallery( $key, $field, $default, $class ){
			...
			echo '
			<div class="amt_metabox_gallery">
				<input name="'. esc_attr( $key ) .'" type="hidden" class="custom_upload_image" value="'. esc_attr( $default ) .'" />
				<div class="custom_preview_images">' . $img_html . '</div>
				<div class="amt_metabox_gallery_buttons">
