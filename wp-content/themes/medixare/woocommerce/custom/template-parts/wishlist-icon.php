...
$title_after  = esc_html__( 'Aleady exists in Wishlist! Click here to view Wishlist', 'medixare' );
...
$html .= '<img class="ajax-loading" alt="spinner" src="'.MedixareTheme_Helper::get_img( 'spinner.gif' ).'">';

if ( $text ) {
	$html .= '<span>' . esc_html__( 'WishList', 'medixare' ) . '</span>';
}
