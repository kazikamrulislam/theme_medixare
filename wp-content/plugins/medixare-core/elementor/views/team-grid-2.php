		...
		?>
				<div class="<?php echo esc_attr($col_class); ?>">
					<div class="team-item <?php echo esc_attr($data['animation']); ?> <?php echo esc_attr($data['animation_effect']); ?>" data-wow-delay="<?php echo esc_attr($i); ?>s" data-wow-duration="<?php echo esc_attr($j); ?>s">
						<div class="amt-team-3__member mb-30 fix">
							<div class="amt-team-3__img w-img">
							...
							<div class="amt-team-3__content text-center">
								<?php if (!empty($socials) && $data['social_display']  == 'yes') { ?>
									<div class="amt-team-2__btns">
										<?php foreach ($socials as $key => $social) : ?>
											<?php if (!empty($social)) : ?>
												<span><a target="_blank" href="<?php echo esc_url($social); ?>"><i class="fab <?php echo esc_attr($social_fields[$key]['icon']); ?>" aria-hidden="true"></i></a></span>
											<?php endif; ?>
										<?php endforeach; ?>
									</div>
								<?php } ?>
								<div class="amt-team-3__title-wrapper">
									<h3 class="amt-team-3__title"><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h3>
									<?php if ($data['designation_display']  == 'yes') { ?>
										<div class="cat"><?php echo esc_html($position); ?></div>
									<?php } ?>
								</div>
							</div>
						</div>
