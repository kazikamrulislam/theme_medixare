...
function rt_demo_import_enqueue_script() {
    wp_enqueue_style('amt-demo', plugin_dir_url(__FILE__) . 'assets/css/demo-page.css');
    wp_enqueue_script('amt-demo', plugin_dir_url(__FILE__) . 'assets/js/demo.js', '', 1.0, true);
}