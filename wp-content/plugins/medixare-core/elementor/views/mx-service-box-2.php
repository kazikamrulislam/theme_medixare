...
<div class="amt-service__info-box amt-about__info-box-2 d-md-flex d-block <?php echo esc_attr($data['style']); ?>">
	<div class="row">
		<?php 
			// $args = array(
			// 	'post_type'      => 'medixare_service',
		...
		?>
			<div class="col-lg-4 col-md-6 col-sm-12 col-xs-12  service_item">
