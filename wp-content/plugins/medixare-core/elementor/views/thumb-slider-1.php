...
<div class="amt-thumb-slider-default medixare-horizontal-slider amt-thumb-slider-<?php echo esc_attr( $data['slider_style'] );?> <?php echo esc_attr( $data['nav_style'] );?>">
        ...
        <?php        
            ...
            <div class="swiper-slide">
                <div class="amt-item amt-slide">
                    <div class="amt-slide-image" data-bg-image="<?php echo get_the_post_thumbnail_url(); ?>"></div>
