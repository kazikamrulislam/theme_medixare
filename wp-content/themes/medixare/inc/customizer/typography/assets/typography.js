jQuery( document ).ready(function($) {
	...
	$('.google-fonts-list').on('change', function() {
		...
		var indexes = $.map(bodyfontcontrol.amtthemefontslist, function(obj, index) {
		...
		$.each(bodyfontcontrol.amtthemefontslist[index].variants, function(val, text) {
		...
		$(this).parent().parent().find('.google-fonts-category').val(bodyfontcontrol.amtthemefontslist[index].category);

		amtthemeGetAllSelects($(this).parent().parent());
	});
	...
	function amtthemeGetAllSelects($element) {
		var selectedFont = {
