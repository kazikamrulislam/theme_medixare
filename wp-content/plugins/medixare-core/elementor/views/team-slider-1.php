...
?>
<div class="team-default team-multi-layout-1 team-slider-<?php echo esc_attr( $data['style'] );?>">
	<div class="amt-swiper-slider swiper-slider amt-swiper-nav-1" data-xld ="<?php echo esc_attr( $data['swiper_data'] );?>">
