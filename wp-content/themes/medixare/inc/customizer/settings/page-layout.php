 ...
 */
class MedixareTheme_Page_Layout_Settings extends MedixareTheme_Customizer {
    ...
    public function register_page_layout_controls( $wp_customize ) {
        ...
        $wp_customize->add_control( 'page_bgtype',
            array(
                ...
                'type' => 'select',
                'default' => esc_html__( 'BG Color', 'medixare' ),
                'choices' => array(
                    'page_bgimg' => esc_html__( 'BG Image', 'medixare' ),
                    'page_bgcolor' => esc_html__( 'BG Color', 'medixare' ),
                ),
            )
        );
        ...
        $wp_customize->add_control( new WP_Customize_Media_Control( $wp_customize, 'page_bgimg',
            array(
                ...
                'active_callback' => 'amttheme_banner_bgimg_type_condition',
            )
        ) );
        ...
        $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'page_bgcolor',
            array(
                ...
                'priority' => 10, 
                'section' => 'page_layout_section',
                'active_callback' => 'amttheme_banner_bgcolor_type_condition',
            )
        ));
...
if ( class_exists( 'WP_Customize_Control' ) ) {
	new MedixareTheme_Page_Layout_Settings();
}
