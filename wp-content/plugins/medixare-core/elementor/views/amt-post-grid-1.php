...
<div class="amt-post-grid-1 amt-post-grid-<?php echo esc_attr($data['style']); ?>">
					...
					<div class="amt-post-grid__item">
						...
						<div class="amt-post-grid__content">
							...
							<?php if ($data['post_read'] == 'yes') { ?>
								<div class="amt-post-grid__btn-wrapper"><a class="tp-readmore-btn" href="<?php the_permalink(); ?>"><?php echo wp_kses_post($data['read_more_text']); ?></a>
								</div>
							<?php } ?>
						</div>
					</div>
