...
?>
<div class="amt-post-list-default number-counter amt-post-list-<?php echo esc_attr( $data['style'] );?>">
			...
			<div class="<?php echo esc_attr( $data['animation'] );?> <?php echo esc_attr( $data['animation_effect'] );?>" data-wow-delay="<?php echo esc_attr( $i );?>s" data-wow-duration="<?php echo esc_attr( $j );?>s">
				<div class="amt-item single-post-item">
					...
					<div class="entry-content">						
						...
						<ul class="entry-meta meta-dark-color mb-0">
						...
						<?php } ?>
						<h3 class="entry-title title-dark-color title-size-xs mb-0"><a href="<?php the_permalink();?>"><?php echo esc_html( $title );?></a></h3>						
					</div>
				</div>
			</div>
