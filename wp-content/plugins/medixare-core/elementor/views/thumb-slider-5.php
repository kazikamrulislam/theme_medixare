...
<div class="amt-thumb-slider-default amt-thumb-slider-<?php echo esc_attr( $data['slider_style'] );?> medixare-vertical-slider">
    <div class="swiper-container vertical-slider" data-xld ="<?php echo esc_attr( $data['swiper_data'] );?>">
        ...
        <?php
            ...
            <div class="swiper-slide">
                <div class="amt-item amt-slide" data-bg-image="<?php echo get_the_post_thumbnail_url(); ?>">
