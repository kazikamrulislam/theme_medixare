...
require_once 'amt-taxmeta-fields.php';

if( !class_exists( 'AMT_TaxMeta' ) ){

	class AMT_TaxMeta extends AMT_Postmeta {
		protected static $term_instance = null;

		private $tax_meta        = array();

		private function __construct() {
			$this->fields_obj = new AMT_TaxMeta_Fields();
