...
class Customizer_Typography_settings {
	...
	public function add_customizer_panels( $wp_customize ) {
	    ...
	    // Add Layput Panel
		$wp_customize->add_panel( 'amttheme_typography_defaults',
		 	array(
				'title' => __( 'Typography', 'medixare' ),
    ...
    *========================================================================================*/
	public function register_typography_sections( $wp_customize ) {
		...
		$wp_customize->add_section( 'typography_body_section',
			array(
				'title' => esc_html__( 'Body', 'medixare' ),
				'priority' => 1,
				'panel' => 'amttheme_typography_defaults',
			)
		);
		...
		$wp_customize->add_section( 'typography_menu_section',
			array(
				'title' => esc_html__( 'Menu', 'medixare' ),
				'priority' => 2,
				'panel' => 'amttheme_typography_defaults',
			)
		);
		...
		$wp_customize->add_section( 'typography_heading_section',
			array(
				'title' => esc_html__( 'Heading', 'medixare' ),
				'priority' => 3,
				'panel' => 'amttheme_typography_defaults',
			)
		);
	...
	public function register_typography_controls( $wp_customize ) {
		...
		$wp_customize->add_control( 'typo_body_size',
			array(
				'label' => __( 'Font Size', 'medixare' ),
				'description' => esc_html__( 'Font Size (px)', 'medixare' ),
				'section' => 'typography_body_section',
				'type' => 'text',
				'input_attrs' => array(
					'class' => 'rtt-txt-box',				
		...
		$wp_customize->add_control( 'typo_body_height',
			array(
				'label' => __( 'Line Height', 'medixare' ),
				'description' => esc_html__( 'Line Height (px)', 'medixare' ),
				'section' => 'typography_body_section',
				'type' => 'text',
				'input_attrs' => array(
					'class' => 'rtt-txt-box',					
		...
		$wp_customize->add_control( 'typo_submenu_size',
			array(
				'label' => __( 'Sub Menu Font Size', 'medixare' ),
				'description' => esc_html__( 'Font Size (px)', 'medixare' ),
				'section' => 'typography_menu_section',
				'type' => 'text',
				'input_attrs' => array(
		...
		$wp_customize->add_control( 'typo_submenu_height',
			array(
				'label' => __( 'Sub Menu Line Height', 'medixare' ),
				'description' => esc_html__( 'Line Height (px)', 'medixare' ),
				'section' => 'typography_menu_section',
				'type' => 'text',
				'input_attrs' => array(
		...
		$wp_customize->add_control( new Customizer_Google_Fonts_Controls( $wp_customize, 'typo_heading',
			array(
				'label' => __( 'All Heading Typography (H1-H6)', 'medixare' ),
...
if ( class_exists( 'WP_Customize_Control' ) ) {
	$amttheme_settings = new Customizer_Typography_settings();
}
