...
?>
<div class="rt-post-slider-default rt-swiper-slider-main3 rt-post-slider-<?php echo esc_attr( $data['style'] );?> <?php echo esc_attr( $data['nav_style'] );?>">
	<div class="swiper-container inner-container3" data-xld ="<?php echo esc_attr( $data['swiper_data'] );?>">
			...
			<div class="swiper-slide">
				<div class="rt-item <?php echo esc_attr( $data['animation'] );?> <?php echo esc_attr( $data['animation_effect'] );?>" data-wow-delay="<?php echo esc_attr( $i );?>s" data-wow-duration="<?php echo esc_attr( $j );?>s">
					<div class="entry-content">	
						...
						<?php } ?>
						<h3 class="entry-title title-size-xl title-light-color"><a href="<?php the_permalink();?>"><?php echo esc_html( $title );?></a></h3>
					...
					<div class="entry-video">	
						<?php if ( ( $data['post_video'] == 'yes' && 'video' == get_post_format( $id ) && !empty( $youtube_link ) ) ) { ?>
							<div class="amt-video"><a class="rt-play play-btn-2 amt-video-popup" href="<?php echo esc_url( $youtube_link );?>"><i class="fas fa-play"></i></a></div>
						<?php } ?>
					</div>
				</div>				
			</div>
