...
<div class="amt-thumb-slider-default amt-thumb-slider-<?php echo esc_attr( $data['slider_style'] );?> medixare-horizontal-slider">
        ...
        <div class="container">
            <div class="swiper-container swiper-item-wrap horizontal-thumb-slider" data-xld ="<?php echo esc_attr( $data['swiper_data'] );?>">
                <div class="swiper-wrapper">
                    ...
                    ?>                   
                    <div class="swiper-slide">
                        <div class="amt-item amt-slide-thumb">
                            <div class="amt-image">
                                <?php
                            ...
                            <div class="entry-content">                     
                                <?php if ( $data['small_post_category'] == 'yes' ) { ?>
                                    ...
                                    <?php } ?>
                                <?php } ?>
                                <h3 class="entry-title title-size-sm title-light-color"><a href="javascript:void(0)"><?php echo esc_html( $small_title );?></a></h3>
