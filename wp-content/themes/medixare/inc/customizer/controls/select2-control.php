...
if ( class_exists( 'WP_Customize_Control' ) ) {
    ...
    class Customizer_Dropdown_Select2_Control extends WP_Customize_Control {
        ...
        public function enqueue() {
            ...
            wp_enqueue_script( 'amttheme-custom-controls-js', trailingslashit( get_template_directory_uri() ) . 'assets/js/customizer.js', array( 'amttheme-select2-js' ), '1.2', true );
            wp_enqueue_style( 'amttheme-custom-controls-css', trailingslashit( get_template_directory_uri() ) . 'assets/css/customizer.css', array(), '1.1', 'all' );
