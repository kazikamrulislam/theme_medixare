...
?>
<div class="rt-post-list-default rt-post-list-<?php echo esc_attr( $data['style'] );?>">
					...
					<div class="<?php echo esc_attr( $data['animation'] );?> <?php echo esc_attr( $data['animation_effect'] );?>" data-wow-delay="<?php echo esc_attr( $i );?>s" data-wow-duration="<?php echo esc_attr( $j );?>s">
						<div class="amt-item single-post-item">
							...
							<div class="entry-content">														
								...
								<?php } ?>
								<h3 class="entry-title title-size-xl title-dark-color"><a href="<?php the_permalink();?>"><?php echo esc_html( $title );?></a></h3>
					...
					<div class="amt-item multi-post-item">
						<div class="rt-image">
							<?php if ( ( $data['small_post_video'] == 'yes' && 'video' == get_post_format( $id ) && !empty( $youtube_link ) ) ) { ?>
								<div class="amt-video video-btn-wrap position-center"><a class="rt-play play-btn size-sm amt-video-popup" href="<?php echo esc_url( $youtube_link );?>"><i class="fas fa-play"></i></a></div>
							<?php } ?>
							<a href="<?php the_permalink(); ?>">
								<?php
									if ( has_post_thumbnail() ){
						...
						<div class="entry-content">		
							...
							<?php } ?>
							<h3 class="entry-title title-size-md title-dark-color mb-0"><a href="<?php the_permalink();?>"><?php echo esc_html( $small_title );?></a></h3>
						</div>
					</div>
				</div>
			<?php } ?>
