 ...
 */
class MedixareTheme_Blog_Layout_Settings extends MedixareTheme_Customizer {
    ...
    public function register_blog_archive_layout_controls( $wp_customize ) {
        ...
        $wp_customize->add_control( 'blog_bgtype',
            array(
                ...
                'type' => 'select',
                'choices' => array(
                    'blog_bgimg' => esc_html__( 'BG Image', 'medixare' ),
                    'blog_bgcolor' => esc_html__( 'BG Color', 'medixare' ),
                ),
            )
        );
        ...
        $wp_customize->add_control( new WP_Customize_Media_Control( $wp_customize, 'blog_bgimg',
            array(
                ...
                'active_callback' => 'amttheme_post_banner_bgimg_type_condition',
            )
        ) );
        ...
        $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'blog_bgcolor',
            array(
                ...
                'priority' => 10, 
                'section' => 'blog_layout_section', 
                'active_callback' => 'amttheme_post_banner_bgcolor_type_condition',
            )
        ));
...
if ( class_exists( 'WP_Customize_Control' ) ) {
	new MedixareTheme_Blog_Layout_Settings();
}
