...
/**
* About Widget with Social for footer by MedixareTheme
**/
class MedixareTheme_Social_Widget extends WP_Widget {

	public function __construct() {
		$widget_ops = array(
			'classname' => 'rt_footer_social_widget',
			'description' => esc_html__( 'Medixare : (For Footer) Social Link widget with Description' , 'medixare-core' ),
			'customize_selective_refresh' => true,
		);
		parent::__construct( 'rt-about-social', esc_html__( 'Medixare : Social Widget' , 'medixare-core' ), $widget_ops );
		$this->alt_option_name = 'medixare_about_widget';
	}
	...
	public function form( $instance ){
		$defaults = array(
			'title'       => esc_html__( 'About Company' , 'medixare-core' ),
			'description' => '',
			'facebook'    => '',
			'twitter'     => '',
			'skype'       => '',
