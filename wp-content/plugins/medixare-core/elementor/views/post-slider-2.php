...
?>
<div class="amt-post-slider-default amt-post-slider-<?php echo esc_attr( $data['style'] );?>">
	<div class="amt-swiper-slider <?php echo esc_attr( $data['nav_style'] );?>" data-xld ="<?php echo esc_attr( $data['swiper_data'] );?>">
				...
				<div class="amt-item <?php echo esc_attr( $data['animation'] );?> <?php echo esc_attr( $data['animation_effect'] );?>" data-wow-delay="<?php echo esc_attr( $i );?>s" data-wow-duration="<?php echo esc_attr( $j );?>s">
					<div class="amt-image">
						<?php if ( ( $data['post_video'] == 'yes' && 'video' == get_post_format( $id ) && !empty( $youtube_link ) ) ) { ?>
							<div class="amt-video video-btn-wrap position-top-left"><a class="amt-play play-btn size-sm amt-video-popup" href="<?php echo esc_url( $youtube_link );?>"><i class="fas fa-play"></i></a></div>
						<?php } ?>
