...
namespace addonmonster\medixare\Customizer\Typography;
...
if ( class_exists( 'WP_Customize_Control' ) ) {
	...
	class Customizer_Google_Fonts_Controls extends WP_Customize_Control {
		...
		public function __construct( $manager, $id, $args = array(), $options = array() ) {
			...
			$this->fontList = $this->amttheme_getGoogleFonts( 'all' );
			// Decode the default json font value
			$this->fontValues = json_decode( $this->value() );
			// Find the index of our default font within our list of Google fonts
			$this->fontListIndex = $this->amttheme_getFontIndex( $this->fontList, $this->fontValues->font );
		}
		...
		public function enqueue() {
			wp_enqueue_script( 'amttheme-select2-js', trailingslashit( get_template_directory_uri() ) . 'assets/js/select2.min.js', array( 'jquery' ), '4.0.6', true );
			wp_enqueue_script( 'amttheme-typography-controls-js', trailingslashit( get_template_directory_uri() ) . 'inc/customizer/typography/assets/typography.js', array( 'amttheme-select2-js' ), '1.2', true );
			wp_enqueue_style( 'amttheme-typography-controls-css', trailingslashit( get_template_directory_uri() ) . 'inc/customizer/typography/assets/typography.css', array(), '1.1', 'all' );
			wp_enqueue_style( 'amttheme-select2-css', trailingslashit( get_template_directory_uri() ) . 'assets/css/select2.min.css', array(), '4.0.6', 'all' );
		}
		...
		public function to_json() {
			parent::to_json();
			$this->json['amtthemefontslist'] = $this->fontList;
		}
		/**
		 ...
		 */
		public function amttheme_getFontIndex( $haystack, $needle ) {
		 ...
		 */
		public function amttheme_getGoogleFonts( $count = 30 ) {
